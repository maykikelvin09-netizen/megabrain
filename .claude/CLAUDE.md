...
1. Run `npx @thiagofinch/mega-brain@latest install` (or `upgrade` for Premium)
...
|-----|---------|-----------|
| `OPENAI_API_KEY` | Whisper transcription (video/audio only) | Recommended (skip if you have .txt/.docx transcripts) |
